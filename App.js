...
function MyTabs() {
  return (
    <Tab.Navigator tabBarOptions={{activeBackgroundColor: 'white', inactiveBackgroundColor: 'white', inactiveTintColor: "black", activeTintColor: "orange"}}>
      ...
      <Tab.Screen name="Create A Post" component={AddPostScreenScreen} options = {{ headerShown: false, tabBarIcon:({color, size}) => (<MaterialCommunityIcons name="plus" color={color} size={size} />)}}/>
